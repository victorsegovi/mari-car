...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden h-screen">
      <div className={`text-[#F1F1F1] bg-[#E62554] h-screen w-full flex flex-col justify-evenly px-4 pb-16 items-center absolute transition-all duration-1000 md:flex-row-reverse bg-pattern ${show? "z-20 left-0 opacity-100": "z-0 left-full opacity-0"}`}>
